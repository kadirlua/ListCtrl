...
public:
	...
	void SetCellTextColor(COLORREF cTextColor);
	void SetCellBackColor(COLORREF cBackColor);
	void SetTooltipText(CString strText);
	void SetTooltipTitle(CString strTitle);
...
protected:
	...
	CString strTooltipTitleText;
	COLORREF m_cTextColor;	//CellTextColor
	COLORREF m_cBackColor;	//CellBackColor
	...
	virtual afx_msg BOOL OnHeaderItemStateIconClick(UINT id, NMHDR* pNMHDR, LRESULT* pResult);
	//}}AFX_MSG
