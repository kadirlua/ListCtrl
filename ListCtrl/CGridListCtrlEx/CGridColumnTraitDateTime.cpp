...
void CGridColumnTraitDateTime::SetDateTime(int nYear, int nMonth, int nDay,
...
CWnd* CGridColumnTraitDateTime::OnEditBegin(CGridListCtrlEx& owner, int nRow, int nCol)
{
	...
	//ParseDateTime(cellText, timeTime);
	...
	pDateTimeCtrl->SetTime(&timeTime);
...
///////////////////////////////////////////////////////////////////
//On key down//////////////////////////////////////////////////////
void CGridEditorDateTimeCtrl::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	switch(nChar)
	{
		case VK_RETURN:
